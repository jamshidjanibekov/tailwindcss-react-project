    ...
    return (
        <div className={`${styles.paddingY} ${styles.flexCenter} flex-col relative`}>
            ...
            <div className={`w-full flex justify-between items-center md:flex-row flex-col sm:mb-16 mb-6 relative z-[1]`}>
                <h2 className={`${styles.heading2}`}>Odamlar biza haqimizda qanday fikrda</h2>
                <div className={'w-full md:mt-0 mt-6'}>
                    <p className={`${styles.paragraph} text-left max-w-[550px]`}>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aut, doloremque eligendi eos fuga quisquam temporibus veritatis.
                    </p>
                </div>
            </div>

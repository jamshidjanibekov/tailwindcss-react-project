        ...
        <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
            ...
            <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6 relative`}>
                ...
                <p className={`${styles.paragraph} mt-5 max-w-[550px]`}>
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab assumenda delectus doloremque fuga harum magni nulla obcaecati officia similique voluptatem?
                </p>
